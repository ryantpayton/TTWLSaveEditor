...
using WonderlandsTools.Decryption;
using OakSave;
using System.Linq;
...
namespace WonderlandsTools
{
    ...
    public static class WonderlandsTools
    {
        public class WonderlandsExceptions
        {
        ...
        /// <summary>
        /// This function writes a <c>UE3Save</c> instance to the drive, deserializes it to the respective classes of <c>WonderlandsProfile</c> or <c>WonderlandsSave</c>
        /// </summary>
        ...
        public static UE3Save LoadFileFromDisk(string filePath, Platform platform = Platform.PC, bool bBackup = false)
        {
            if (platform == Platform.JSON)
            {
                ...
                try
                {
                    ...
                    {
                        throw new WonderlandsExceptions.InvalidSaveException("Not supported PS4 Save Wizard profile.");
                    }
                    else
                    {
                        ...
                        //saveGame = new WonderlandsSave(new GVASSave(-1, -1, -1, -1, -1, 0, null, -1, -1, new Dictionary<byte[], int>(), "BPSaveGame_Default_C"), character);
                        ...
                        saveGame = new WonderlandsSave(new GVASSave(2, 516, 4, 20, 3, 2150344073, "DAFFODIL-PATCHDIESEL1-68", 3, 59, dictbuf, "BPSaveGame_Default_C"), character);
                        
                        (saveGame as WonderlandsSave).Platform = platform;
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (saveData == null)
                    {
                        throw new WonderlandsExceptions.InvalidSaveException();
                    }
                    ...
                    switch (saveGameType)
                    {
                        ...
                        case "OakProfile":
                            ...
                            saveGame = new WonderlandsProfile(saveData, Serializer.Deserialize<Profile>(new MemoryStream(buffer)));
                            (saveGame as WonderlandsProfile).Platform = platform;
                            break;
                        // Decrypt a save game
                        case "BPSaveGame_Default_C":
                            SaveBogoCrypt.Decrypt(buffer, 0, remainingData, platform);
                            saveGame = new WonderlandsSave(saveData, Serializer.Deserialize<Character>(new MemoryStream(buffer)));
                            (saveGame as WonderlandsSave).Platform = platform;
                            break;
                        default:
                            throw new WonderlandsExceptions.InvalidSaveException(saveGameType);
                    }
                }
                catch (ProtoBuf.ProtoException ex)
                {
                    ...
                    {
                        throw new WonderlandsExceptions.InvalidSaveException(platform);
                    }
                ...
                using (var stream = new MemoryStream())
                {
                    switch (saveGame.GVASData.sgType)
                    {
                        case "OakProfile":
                            ...
                            WonderlandsProfile vx = (WonderlandsProfile)saveGame;
                            ...
                            break;
                        case "BPSaveGame_Default_C":
                            WonderlandsSave save = (WonderlandsSave)saveGame;
                            ...
                            if (save.Platform == Platform.JSON)
                            {
                                ...
                                foreach (WonderlandsSerial serial in save.InventoryItems)
                                {
                                    ...
                                    {
                                        throw new WonderlandsExceptions.SerialParseException(serial.EncryptSerial(), serial.SerialVersion, serial.SerialDatabaseVersion);
                                    }
                        ...
                        default:
                            throw new WonderlandsExceptions.InvalidSaveException(saveGame.GVASData.sgType);
                    }
                }
