...
namespace WonderlandsTools
{
    ...
    /// <summary>
    /// A simple underlying class that's used to store both <see cref="WonderlandsSave"/> and <see cref="WonderlandsProfile"/>
    /// </summary>
    ...
    /// </summary>
    public class WonderlandsSave : UE3Save
    {
        public WonderlandsSave(GVASSave saveData, Character character)
        {
            GVASData = saveData;
            Character = character;
    ...
    /// </summary>
    public class WonderlandsProfile : UE3Save
    {
        public WonderlandsProfile(GVASSave gvasSave, Profile profile)
        {
