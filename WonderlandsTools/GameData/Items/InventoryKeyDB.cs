...
namespace WonderlandsTools.GameData.Items {
    public static class InventoryKeyDB {
        ...
        private static readonly string embeddedDatabasePath = "WonderlandsTools.GameData.Items.Mappings.balance_to_inv_key.json";
        private static readonly string embeddedReduxDatabasePath = "WonderlandsTools.GameData.Items.Mappings.balance_to_inv_key_redux.json";
