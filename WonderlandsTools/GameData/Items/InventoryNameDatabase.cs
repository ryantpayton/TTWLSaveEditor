...
namespace WonderlandsTools.GameData.Items {
    public static class InventoryNameDatabase {
        ...
        private static readonly string embeddedNameDatabase = "WonderlandsTools.GameData.Items.Mappings.part_name_mapping.json";
        private static readonly string embeddedPrefixDatabase = "WonderlandsTools.GameData.Items.Mappings.prefix_name_mapping.json";
        private static readonly string embeddedReduxNameDatabase = "WonderlandsTools.GameData.Items.Mappings.part_name_mapping_redux.json";
