...
namespace WonderlandsTools.GameData
{
    public static class DataPathTranslations
    {
        ...
        private static readonly string embeddedFastTravelDatabasePath = "WonderlandsTools.GameData.Mappings.fast_travel_to_name.json";
