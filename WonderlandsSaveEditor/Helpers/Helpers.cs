...
namespace WonderlandsSaveEditor.Helpers
{
    /// <summary>
    ...
    public class StringToCharacterClassConverter : IValueConverter
    {
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value != null)
            {
                PlayerClassSaveGameData data = WonderlandsSave.ValidClasses.Where(x => x.Key.Equals((string)value)).First().Value;
                return data;
            }
            return null;
        }
    ...
    public class StringToAbilityBranchConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value != null)
            {
                string result = WonderlandsSave.ValidAbilityBranches.Where(x => x.Value.Equals((string)value)).First().Key;
                return result;
            }
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value != null)
            {
                value = WonderlandsSave.ValidAbilityBranches.Where(x => x.Key.Equals((string)value)).First().Value;
                return value;
            }
            return null;
        }
    ...
    public class StringToPlayerAspectDataConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value != null)
            {
                string result = WonderlandsSave.ValidPlayerAspect.Where(x => x.Value.Equals((string)value)).First().Key;
                return result;
            }
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value != null)
            {
                value = WonderlandsSave.ValidPlayerAspect.Where(x => x.Key.Equals((string)value)).First().Value;
                return value;
            }
            return null;
        }
    ...
    public class StringToPlayerPronounDataConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value != null)
            {
                string result = WonderlandsSave.ValidPlayerPronouns.Where(x => x.Value.Equals((string)value)).First().Key;
                return result;
            }
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value != null)
            {
                value = WonderlandsSave.ValidPlayerPronouns.Where(x => x.Key.Equals((string)value)).First().Value;
                return value;
            }
            return null;
        }
